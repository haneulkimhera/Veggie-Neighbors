 ...
 * Use the [MyfridgeFragment.newInstance] factory method to
...
class MyfridgeFragment : Fragment() {
    ...
    lateinit var binding:FragmentMyfridgeBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentMyfridgeBinding.inflate(inflater)
        return binding.root
    }
